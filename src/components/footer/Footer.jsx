        ...
        <div className={styles.tabs}>
            ...
            <div className={styles.right}>
                ...
                <div className={styles.copyright}>
                    <p className={styles.copyrightText}>&copy; Blogy 2023. Made by ligogo.</p>
                </div>
            </div>
        </div>
    </footer>
